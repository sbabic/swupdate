...
copyright = u'2013-2021, Stefano Babic'
...
# pixels large.
html_favicon = "images/SWUpdate.ico"
...
latex_documents = [('index', 'SWUpdate.tex', u'Software Update Documentation', u'Stefano Babic', 'manual')]
